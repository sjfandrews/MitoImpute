...
typ_map.path = snakemake@input[['typ_map']]
typ_ped.path = snakemake@input[['typ_ped']]
imp_map.path = snakemake@input[['imp_map']]
imp_ped.path = snakemake@input[['imp_ped']]
imp_info.path = snakemake@input[['imp_info']]
outdir = snakemake@params[['output_dir']]
sample = snakemake@params[['sample']]
info_cut = snakemake@params[['info_cut']]
