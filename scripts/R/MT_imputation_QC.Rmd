...
params:
  ...
  imp.vcf: '/Users/sheaandrews/Documents/Test2/chrMT_1kg_Human610-Quadv1_B-b37_imp.vcf'
...
ggplot(dat_ggforce, aes(x = x, id = id, split = y, value = n)) +
  ...
  geom_parallel_sets_labels(colour = 'black', angle = 0, label = c(labs1, labs2), size = 3) + 
