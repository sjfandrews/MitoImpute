...
##  Read in - Typed only
#     Plink .ped files 
samp_typ.ped <- generate_snp_data_fixed(params$typ_map, params$typ_ped)

##  Read in - Imputed 
#     Plink .ped files 
samp_imp.ped <- generate_snp_data_fixed(params$imp_map, params$imp_ped) 
...
```{r out, echo=FALSE, warning =FALSE, message=FALSE}

## Write out Haplogroups
out <- full_join(MTimp.classifications, samp_imp.filtered, by = 'Individual')
write_tsv(out, paste0(params$out, '/', params$sample, '_Haplogroups.txt'))
